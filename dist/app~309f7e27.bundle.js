"use strict";
(self["webpackChunkkuliner_viral"] = self["webpackChunkkuliner_viral"] || []).push([[631],{
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _templates_template_creator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7724);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
    ...
    value: function showFavoriteRestaurants() {
      ...
      if (restaurants.length) {
        html = restaurants.reduce(function (carry, restaurant) {
          return carry.concat((0,_templates_template_creator__WEBPACK_IMPORTED_MODULE_0__/* .createRestaurantListTemplate */ .wT)(restaurant));
        }, '');
      } else {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $B: () => (/* binding */ createCustomerReviewFormTemplate),
/* harmony export */   Ah: () => (/* binding */ createUnlikeRestaurantButtonTemplate),
/* harmony export */   TV: () => (/* binding */ createRestaurantDetailTemplate),
/* harmony export */   nG: () => (/* binding */ createLikeRestaurantButtonTemplate),
/* harmony export */   tP: () => (/* binding */ createCustomerReviewTemplate),
/* harmony export */   wT: () => (/* binding */ createRestaurantListTemplate)
/* harmony export */ });
/* harmony import */ var _global_config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2120);
/* harmony import */ var _utils_detail_helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2308);
/* eslint-disable import/no-cycle */


var createRestaurantDetailTemplate = function createRestaurantDetailTemplate(restaurant) {
  return "\n<img class=\"restaurant-picture lazyload\" crossorigin=\"anonymous\" alt=\"".concat(restaurant.name, "\" data-src=\"").concat(_global_config__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.BASE_IMAGE_URL + restaurant.pictureId, "\" tabindex=\"0\" >\n<div class=\"detailRestaurant\">\n    <div class=\"detailRestaurant-info\">\n        <div class=\"detailRestaurant-name\">\n            <h2><i class=\"fas fa-store\"></i> Restaurant Name</h2>\n            <p class=\"list-item__title\">").concat(restaurant.name, "</p>\n        </div>\n        <div class=\"detailRestaurant-address\">\n            <h2><i class=\"far fa-compass\"></i> Restaurant Address</h2>\n            <p>").concat(restaurant.address, ", ").concat(restaurant.city, "</p>\n        </div>\n        <div class=\"detailRestaurant-rate\">\n            <h2><i class=\"far fa-star\"></i> Restaurant Rate</h2>\n            <p>").concat(restaurant.rating, "</p>\n        </div>\n    </div>\n    <h2 class=\"restaurant-description-title\">Description</h2>\n    <p class=\"restaurant-description\">").concat(restaurant.description, "</p>\n</div>\n<div class=\"restaurant-categories\">\n    ").concat(restaurant.categories.map(function (category) {
  ...
  }).join(''), "\n        </ul>\n    </div>\n</div>\n<h2 class=\"restaurant-review-title\">Customer Review</h2>\n").concat(_utils_detail_helper__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.eachCustomerReview(restaurant), "\n");
};
