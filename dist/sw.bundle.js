...
var assetsToCache = ['./', './icons/icon-72x72.png', './icons/icon-96x96.png', './icons/icon-128x128.png', './icons/icon-144x144.png', './icons/icon-152x152.png', './icons/icon-192x192.png', './icons/icon-384x384.png', './icons/icon-512x512.png', './index.html', './favicon.png', './app.bundle.js', './app.webmanifest', './sw-workbox.bundle.js'];
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkkuliner_viral"] = self["webpackChunkkuliner_viral"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [452], () => (__webpack_require__(9212)))
